...
export const deleteTransactionController = async (req, res) => {
  try {
    ...
    // Remove the deleted transaction id from the user's transactions array
    const transactionArr = user.transactions.filter((transaction) => {
      // transaction may be an ObjectId or a subdocument with _id
      const tId = transaction && transaction._id ? transaction._id.toString() : transaction.toString();
